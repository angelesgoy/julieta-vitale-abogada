...
export default function About() {
  return <><Header/><main>
    ...
    <section className="about-story">
      ...
      <div className="story-block"><h2>Enfoque de trabajo</h2>
      ...
      <div className="about-cta"><h2>Estoy para ayudarte</h2><p>Si vos o alguien de tu familia está pasando por una situación legal, no dudes en contactarme.</p><a className="button" href={whatsapp} target="_blank" rel="noreferrer"><span className="button-icon" aria-hidden="true">◔</span> Contactar por WhatsApp</a></div>
    </section>
  </main><Footer/></>;
}
